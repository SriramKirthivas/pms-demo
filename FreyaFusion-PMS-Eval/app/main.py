"""FreyaFusion PMS — Eval service (pm-eval). Scaffold — implement per spec."""
...
from .eval.router import router as domain_router  # noqa: E402
...
app = FastAPI(title="FreyaFusion PMS — Eval", version="0.1.0", lifespan=lifespan)
app.add_middleware(
...
@app.get("/api/health")
def health() -> dict:
    return {"status": "ok", "service": "pm-eval"}
